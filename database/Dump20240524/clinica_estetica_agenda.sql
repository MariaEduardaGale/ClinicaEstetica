...
CREATE TABLE `agenda` (
  ...
  CONSTRAINT `agenda_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`),
  CONSTRAINT `agenda_ibfk_2` FOREIGN KEY (`id_compromisso`) REFERENCES `compromisso` (`id_compromisso`)
...
INSERT INTO `agenda` VALUES (1,1,3),(2,3,1);
