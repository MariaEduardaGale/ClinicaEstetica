...
CREATE TABLE `prestado` (
  `id_prestado` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `prestado_ibfk_1` FOREIGN KEY (`id_compromisso`) REFERENCES `compromisso` (`id_compromisso`),
  CONSTRAINT `prestado_ibfk_2` FOREIGN KEY (`id_servico`) REFERENCES `servico` (`id_servico`)
...
INSERT INTO `prestado` VALUES (1,'agendado','concluido','crédito',1,17),(2,'agendado','concluido','débito',2,1),(3,'agendado','concluido','dinheiro',3,26),(4,'agendado','concluido','pix',4,8),(5,'agendado','cancelado','crédito e pix',5,29);
